const TagSetting = () => {
  return (
    <div className='px-4 py-6 sm:p-8'>
      ...
      <div>
        <button className='flex gap-2 items-center text-neutral-500 hover:text-neutral-900 border border-dashed rounded py-4 px-6 w-full whitespace-nowrap truncate font-semibold dark:border-neutral-700 dark:text-neutral-400 dark:hover:text-white hover:border-solid dark:hover:bg-white/5 hover:bg-neutral-50'>
          <svg
            xmlns='http://www.w3.org/2000/svg'
            fill='none'
            viewBox='0 0 24 24'
